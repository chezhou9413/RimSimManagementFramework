    ...
    public partial class Zone_Shop : Zone
    {
        ...
        private bool ComputeValidShopNow(out string message)
        {
            ...
            if (!hasStorage && !hasServiceProvider)
                hasServiceProvider = CustomerActionAttractionUtility.HasAvailableProvider(this);
