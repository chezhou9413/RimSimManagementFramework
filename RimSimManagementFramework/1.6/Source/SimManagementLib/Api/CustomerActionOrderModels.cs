...
namespace SimManagementLib.Api
{
    ...
    public class CustomerActionOrder : IExposable
    {
        ...
        public bool billRegistered;
        public bool financeRegistered;
        ...
        public List<ActionOrderChargeLine> chargeLines = new List<ActionOrderChargeLine>();
        public List<ActionDeliveredThing> deliveredThings = new List<ActionDeliveredThing>();
        ...
        public void ExposeData()
        {
            ...
            Scribe_Values.Look(ref billRegistered, "billRegistered", false);
            Scribe_Values.Look(ref financeRegistered, "financeRegistered", false);
            ...
            Scribe_Collections.Look(ref chargeLines, "chargeLines", LookMode.Deep);
            Scribe_Collections.Look(ref deliveredThings, "deliveredThings", LookMode.Deep);
