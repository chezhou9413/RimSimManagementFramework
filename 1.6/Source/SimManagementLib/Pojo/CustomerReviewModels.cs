...
namespace SimManagementLib.Pojo
{
    ...
    public class CustomerReviewRecord : IExposable
    {
        ...
        public string gameConditionSummary = "";
        public string colonyWealthSummary = "";
        public string colonyShopSummary = "";
        public string colonyLeaderSummary = "";
        public string colonyCultureSummary = "";
        ...
        public void ExposeData()
        {
            ...
            Scribe_Values.Look(ref roomSummary, "roomSummary", "");
            Scribe_Values.Look(ref relationSummary, "relationSummary", "");
            Scribe_Values.Look(ref weatherSummary, "weatherSummary", "");
            Scribe_Values.Look(ref gameConditionSummary, "gameConditionSummary", "");
            Scribe_Values.Look(ref colonyWealthSummary, "colonyWealthSummary", "");
            Scribe_Values.Look(ref colonyShopSummary, "colonyShopSummary", "");
            Scribe_Values.Look(ref colonyLeaderSummary, "colonyLeaderSummary", "");
            Scribe_Values.Look(ref colonyCultureSummary, "colonyCultureSummary", "");
